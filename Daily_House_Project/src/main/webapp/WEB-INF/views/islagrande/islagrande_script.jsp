...
<!-- loader -->
  ...
  <script src="/islagrande/js/owl.carousel.min.js"></script>
  <script src="/islagrande/js/jquery.magnific-popup.min.js"></script>
  <script src="/islagrande/js/aos.js"></script>
  <script src="/islagrande/js/jquery.animateNumber.min.js"></script>
  <script src="/islagrande/js/bootstrap-datepicker.js"></script>
  <script src="/islagrande/js/jquery.timepicker.min.js"></script>
