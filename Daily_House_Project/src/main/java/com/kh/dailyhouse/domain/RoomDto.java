...
public class RoomDto {
	...
	public RoomDto(int room_num, String room_type_num, String user_email, String room_location, int room_score,
			...
			String room_location_detail, String room_option_code, String user_name, String user_phone,
			String user_pic) {
		super();
	...
	public String toString() {
		return "RoomDto [room_num=" + room_num + ", room_type_num=" + room_type_num + ", user_email=" + user_email
				...
				+ ", room_bathroom=" + room_bathroom + ", room_title=" + room_title + ", room_location_detail="
				+ room_location_detail + ", room_option_code=" + room_option_code + ", user_name=" + user_name
